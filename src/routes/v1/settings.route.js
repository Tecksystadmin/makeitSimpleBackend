...
router
  .route('/')
  .patch(validate(settingValidation.updateSettings), settingController.updateSettings)
 ...
 *    get:
 *      summary: Get a user
 *      description: Logged in Settings can fetch only their own user information. Only admins can fetch other Settings.
 *      tags: [Settings]
 *      security:
 *        - bearerAuth: []
 *      parameters:
